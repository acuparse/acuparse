...
CREATE EVENT `trim_windspeed` ON SCHEDULE EVERY 1 DAY STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE ENABLE DO DELETE
                                                                                                                    FROM `windspeed`
...
CREATE EVENT `trim_temperature` ON SCHEDULE EVERY 1 DAY STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE ENABLE DO DELETE
                                                                                                                      FROM `temperature`
                                                                                                                      WHERE `timestamp` < (NOW() - INTERVAL 24 HOUR);
...
CREATE EVENT `trim_humidity` ON SCHEDULE EVERY 1 DAY STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE ENABLE DO DELETE
                                                                                                                   FROM `humidity`
                                                                                                                   WHERE `timestamp` < (NOW() - INTERVAL 24 HOUR);
...
CREATE EVENT `trim_winddirecton` ON SCHEDULE EVERY 1 DAY STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE ENABLE DO DELETE
                                                                                                                       FROM `winddirection`
                                                                                                                       WHERE `timestamp` < (NOW() - INTERVAL 24 HOUR);
...
CREATE EVENT `trim_pressure` ON SCHEDULE EVERY 1 DAY STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE ENABLE DO DELETE
                                                                                                                   FROM `pressure`
                                                                                                                   WHERE `timestamp` < (NOW() - INTERVAL 24 HOUR);
...
CREATE EVENT `rebuild_wu_updates` ON SCHEDULE EVERY 1 MONTH STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE DO ALTER TABLE `wu_updates`
    ENGINE = InnoDB;
...
CREATE EVENT `rebuild_wc_updates` ON SCHEDULE EVERY 1 MONTH STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE DO ALTER TABLE `wc_updates`
    ENGINE = InnoDB;
...
CREATE EVENT `rebuild_cwop_updates` ON SCHEDULE EVERY 1 MONTH STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE DO ALTER TABLE `cwop_updates`
    ENGINE = InnoDB;
...
CREATE EVENT `rebuild_pws_updates` ON SCHEDULE EVERY 1 MONTH STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE DO ALTER TABLE `pws_updates`
    ENGINE = InnoDB;
...
CREATE EVENT `rebuild_windy_updates` ON SCHEDULE EVERY 1 MONTH STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE DO ALTER TABLE `windy_updates`
    ENGINE = InnoDB;
...
CREATE EVENT `rebuild_generic_updates` ON SCHEDULE EVERY 1 MONTH STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE DO ALTER TABLE `generic_updates`
    ENGINE = InnoDB;

CREATE EVENT `trim_light` ON SCHEDULE EVERY 1 MONTH STARTS '1970-01-01 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO TRUNCATE TABLE `light`;
CREATE EVENT `rebuild_light` ON SCHEDULE EVERY 1 MONTH STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE DO OPTIMIZE TABLE `light`;

CREATE EVENT `trim_uvindex` ON SCHEDULE EVERY 1 MONTH STARTS '1970-01-01 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO TRUNCATE TABLE `uvindex`;
CREATE EVENT `rebuild_uvindex` ON SCHEDULE EVERY 1 MONTH STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE DO OPTIMIZE TABLE `uvindex`;
...
CREATE EVENT `trim_tower_data` ON SCHEDULE EVERY 1 MONTH STARTS '1970-01-01 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO TRUNCATE TABLE `tower_data`;
CREATE EVENT `rebuild_tower_data` ON SCHEDULE EVERY 1 MONTH STARTS '1970-01-01 00:00:00' ON COMPLETION PRESERVE DO OPTIMIZE TABLE `tower_data`;