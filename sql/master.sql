...
ALTER TABLE `dailyrain`
  ADD PRIMARY KEY (`date`), ADD UNIQUE KEY `date` (`date`);
...
ALTER TABLE `sessions`
  ADD PRIMARY KEY (`device_key`), ADD KEY `uid` (`uid`);

ALTER TABLE `temperature`
  ADD PRIMARY KEY (`timestamp`);

ALTER TABLE `towers`
  ADD PRIMARY KEY (`sensor`), ADD UNIQUE KEY `sensor` (`sensor`);

ALTER TABLE `tower_data`
  ADD PRIMARY KEY (`id`), ADD KEY `sensor` (`sensor`);
