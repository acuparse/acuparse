...
class getArchiveAtlasWeatherData
{
    ...
    function __construct()
    {
        ...
        $this->uvindex_high_recorded_ever = date('j M Y @ H:i', strtotime($result['reported'])); // Recorded at
        ...
        $this->light_high_recorded_ever = date('j M Y @ H:i', strtotime($result['reported'])); // Recorded at
        ...
        $this->lightSeconds_high_yesterday = (int)$result['lightSeconds']; // Percent
        // This Week High
        $result = mysqli_fetch_assoc(mysqli_query($conn,
        ...
        $this->lightSeconds_high_week = (int)$result['lightSeconds']; // Percent
        // This Month High
        $result = mysqli_fetch_assoc(mysqli_query($conn,
        ...
        $this->lightSeconds_high_month = (int)$result['lightSeconds']; // Percent
        // Last Month High
        $result = mysqli_fetch_assoc(mysqli_query($conn,
        ...
        $this->lightSeconds_high_last_month = (int)$result['lightSeconds']; // Percent
        // This Year High
        $result = mysqli_fetch_assoc(mysqli_query($conn,
        ...
        $this->lightSeconds_high_year = (int)$result['lightSeconds']; // Percent
        // All Time High
        $result = mysqli_fetch_assoc(mysqli_query($conn,
        ...
        $this->lightSeconds_high_recorded_ever = date('j M Y @ H:i', strtotime($result['reported'])); // Recorded at
        $this->lightSeconds_high_ever = (int)$result['lightSeconds']; // Percent
        ...
        $this->lightning_recorded_ever = date('j M Y @ H:i', strtotime($result['reported'])); // Recorded at
