...
// Load Archive Weather Data:
    ...
    <section id="archive-weather-data" class="row archive-weather-data">
        ...
        <div class="col">
            ...
            <div class="row">
                ...
                <section id="archive-weather-data-yesterday" class="col-md-4 col-12">
                    <h1>Yesterday:</h1>
                    <h2><i class="fas fa-thermometer-half" aria-hidden="true"></i> Temperature:</h2>
                    ...
                    <h2><i class="wi wi-windy" aria-hidden="true"></i> Wind</h2>
                    <p><?php
                        if ($config->site->hide_alternate === 'false' || $config->site->hide_alternate === 'live') {
                    ...
                    <h2 class="margin-top-05"><i class="wi wi-barometer" aria-hidden="true"></i> Pressure:</h2>
                    <ul class="list-unstyled">
                        <li><h3>High:</h3> <?php
                            if ($config->site->hide_alternate === 'false' || $config->site->hide_alternate === 'live') {
                    ...
                    <ul class="list-unstyled">
                        <li><h3>High:</h3> <?= "$yesterday->relH_high% @ " . $yesterday->relH_high_recorded; ?></li>
                        <li><h3>Low:</h3> <?= "$yesterday->relH_low% @ " . $yesterday->relH_low_recorded; ?></li>
                    </ul>
                    <?php if ($yesterday->rainfall_IN_total !== 0.) { ?>
                        <h2><i class="wi wi-raindrops" aria-hidden="true"></i> Rainfall:</h2>
                        <h3>Total Rain:</h3> <?php
                        if ($config->site->hide_alternate === 'false' || $config->site->hide_alternate === 'live') {
                ...
                <section id="archive-weather-data-week" class="col-md-4 col-12">
                    ...
                    <h2><i class="wi wi-humidity" aria-hidden="true"></i> Humidity:</h2>
                    <ul class="list-unstyled">
                        <li><h3>High:</h3> <?= "$week->relH_high% on " . $week->relH_high_recorded; ?></li>
                        <li><h3>Low:</h3> <?= "$week->relH_low% on " . $week->relH_low_recorded; ?></li>
                    </ul>
                    <?php if ($week->rainfall_IN_total !== 0.) { ?>
                        <h2><i class="wi wi-raindrops" aria-hidden="true"></i> Rainfall:</h2>
                        <ul class="list-unstyled">
                            <li><h3>Most Rain:</h3> <?php
                                if ($config->site->hide_alternate === 'false' || $config->site->hide_alternate === 'live') {
                ...
                <section id="archive-weather-data-month" class="col-md-4 col-12">
                    ...
                    <h2><i class="wi wi-humidity" aria-hidden="true"></i> Humidity:</h2>
                    <ul class="list-unstyled">
                        <li><h3>High:</h3> <?= "$month->relH_high% on " . $month->relH_high_recorded; ?></li>
                        <li><h3>Low:</h3> <?= "$month->relH_low% on " . $month->relH_low_recorded; ?></li>
                    </ul>
            ...
            <div class="row">
                ...
                <section id="archive-weather-data-last-month" class="col-md-4 col-12">
                    ...
                    <h2><i class="wi wi-humidity" aria-hidden="true"></i> Humidity:</h2>
                    <ul class="list-unstyled">
                        <li><h3>High:</h3> <?= "$last_month->relH_high% on " . $last_month->relH_high_recorded; ?>
                        </li>
                        <li><h3>Low:</h3> <?= "$last_month->relH_low% on " . $last_month->relH_low_recorded; ?></li>
                    </ul>
                ...
                <section id="archive-weather-data-year" class="col-md-4 col-12">
                    ...
                    <h2><i class="wi wi-humidity" aria-hidden="true"></i> Humidity:</h2>
                    <ul class="list-unstyled">
                        <li><h3>High:</h3> <?= "$year->relH_high% on " . $year->relH_high_recorded; ?></li>
                        <li><h3>Low:</h3> <?= "$year->relH_low% on " . $year->relH_low_recorded; ?></li>
                    </ul>
                ...
                <section id="archive-weather-data-all" class="col-md-4 col-12">
                    <h1 class="panel-heading">All Time:</h1>
                    <h2><i class="fas fa-thermometer-half" aria-hidden="true"></i> Temperature:</h2>
                    <ul class="list-unstyled">
                        <li><h3>High:</h3> <?php
                            if ($config->site->hide_alternate === 'false' || $config->site->hide_alternate === 'live') {
                    ...
                    <h2><i class="wi wi-humidity" aria-hidden="true"></i> Humidity:</h2>
                    <ul class="list-unstyled">
                        <li><h3>High:</h3> <?= "$ever->relH_high% on " . $ever->relH_high_recorded; ?></li>
                        <li><h3>Low:</h3> <?= "$ever->relH_low% on " . $ever->relH_low_recorded; ?></li>
                    </ul>
